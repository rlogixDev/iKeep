            ...
            <div id="ResetPassword" >
                <form className="container mx-auto col-4 d-flex justify-content-center flex-column">
                    ...
                    <div id="ResetPassword-buttons" className="row justify-content-end ">
                        <div >
                            <button variant="primary" type="button" className="btn btn-primary btn-lg btn-block" onClick={()=>handleSubmit()}>Reset Password</button>
                        </div>
                    </div>
                    ...
                    <div className="row ">
                        ...
                        <p className="link">Login with new Password <Link to="/">Log In</Link></p>
                    </div>
                </form>
            </div>
        </div>
