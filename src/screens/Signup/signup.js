...
export default function Signup() {
  ...
  async function signUp() {     
    ...
    await createUserWithEmailAndPassword(auth, "email@email,com", "email")
  .then((userCredential) => {
    // Signed in 
        ...
        <Container>
          ...
          <Form.Group className="mb-3">
            ...
            <Row className="justify-content-center">
              ...
              <Col sm="8"> <Form.Control type="password" placeholder="Enter Password" onChange={e => setPassword(e.target.value)}/></Col>
            </Row>
          ...
          <Form.Group className="mb-3">
            ...
            <Row className="justify-content-center">
              ...
              <Col sm="8"> <Form.Control type="text" placeholder="Enter E-mail" onChange={e => setEmail(e.target.value)}/></Col>
            </Row>
          ...
          <Form.Group className="mb-3">
            ...
            <Row className="justify-content-start ">
              <Col sm="4" ></Col>
              <Col sm={8} className="d-flex justify-content-start"><Button type="submit" className="mb-3" onClick={()=>signUp()}>Register</Button></Col>
            </Row>
          </Form.Group>
